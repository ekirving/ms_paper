...
p <- add_argument(p, "--trait1", help = "The first complex trait name", default = "cd-r0.05-kb250")
p <- add_argument(p, "--trait2", help = "The second complex trait name", default = "ra-r0.05-kb250")
...
p <- add_argument(p, "--output", help = "Output file", default = "data/targets/gwas_cd-r0.05-kb250_vs_ra-r0.05-kb250_ancestral_paths_new_palm.tsv")
