...
p <- add_argument(p, "--sites", help = "List of callable sites in the current dataset", default = "data/sites/ancestral_paths_v3_sites.tsv.gz")
...
p <- add_argument(p, "--output", help = "Output file", default = "data/targets/gwas_ms-r0.05-kb250_ancestral_paths_v3_palm.tsv")
