...
p <- add_argument(p, "--all-json", help = "PALM json file for ALL", default = "results/palm/ancestral_paths_v3-ALL-ms-palm.json")
p <- add_argument(p, "--ana-json", help = "PALM json file for ANA", default = "results/palm/ancestral_paths_v3-ANA-ms-palm.json")
p <- add_argument(p, "--chg-json", help = "PALM json file for CHG", default = "results/palm/ancestral_paths_v3-CHG-ms-palm.json")
p <- add_argument(p, "--ehg-json", help = "PALM json file for EHG", default = "results/palm/ancestral_paths_v3-EHG-ms-palm.json")
p <- add_argument(p, "--whg-json", help = "PALM json file for WHG", default = "results/palm/ancestral_paths_v3-WHG-ms-palm.json")
p <- add_argument(p, "--all-tsv", help = "PALM report for ALL", default = "results/palm/ancestral_paths_v3-ALL-ms-palm_report_prs.tsv")
p <- add_argument(p, "--ana-tsv", help = "PALM report for ANA", default = "results/palm/ancestral_paths_v3-ANA-ms-palm_report_prs.tsv")
p <- add_argument(p, "--chg-tsv", help = "PALM report for CHG", default = "results/palm/ancestral_paths_v3-CHG-ms-palm_report_prs.tsv")
p <- add_argument(p, "--ehg-tsv", help = "PALM report for EHG", default = "results/palm/ancestral_paths_v3-EHG-ms-palm_report_prs.tsv")
p <- add_argument(p, "--whg-tsv", help = "PALM report for WHG", default = "results/palm/ancestral_paths_v3-WHG-ms-palm_report_prs.tsv")
p <- add_argument(p, "--output", help = "PALM trajectory", default = "results/palm/ancestral_paths_v3-ms-delta_prs.png")
